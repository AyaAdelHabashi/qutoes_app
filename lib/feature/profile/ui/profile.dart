      ...
      child: Padding(
        ...
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ProfileHeader(name: "ندى ايهاب خالد", email: "nada@gmail.com", imageUrl: "https://i.pravatar.cc/300"),
                SizedBox(height: 16),
                //  ProfileActions(),
                ProfileOptionTile(icon: 'assets/images/edit_profile.svg', title: tr("edit_profile"), onTap: () {}),
                SizedBox(height: 8),
                ProfileOptionTile(
